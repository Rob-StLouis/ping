...
qplot(Household_Income,UseSubstance,geom=c("smooth"),method="glm",data=Data[-122,][Data$Log10_Household_Income>4.5,],facets=.~rs12364283)+geom_point(aes(Household_Income,jitter(UseSubstance)))+ theme(axis.text.x = element_text(angle = 90, hjust = 1))+scale_x_continuous(labels = comma) +xlab("Household Income")+ ylab("Used a Substance (1 = Yes)" )+ ggtitle("Figure2b: \n Influence of rs12364283 Alleles \n and Income on Substance Use, \n Income>$30,000")
```
\newpage



**Likelihood Ratio Test of the Interaction between DRD2 and Income on Substance Use for Incomes >$30,000 and the Outlier Dropped**  
